...
public interface IPageService
{
    ...
    Task<IEnumerable<PageDto>> GetAllPagesAsync(CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<PageDto>> GetPagesByAuthorAsync(string username, CancellationToken cancellationToken = default);
    Task<IEnumerable<PageDto>> GetPagesByTagAsync(string tagName, CancellationToken cancellationToken = default);
    Task<PageDto> CreatePageAsync(CreatePageDto dto, CancellationToken cancellationToken = default);
    Task UpdatePageAsync(UpdatePageDto dto, CancellationToken cancellationToken = default);
    Task DeletePageAsync(int pageId, CancellationToken cancellationToken = default);
    Task<IEnumerable<PageContentDto>> GetPageHistoryAsync(int pageId, CancellationToken cancellationToken = default);
}
