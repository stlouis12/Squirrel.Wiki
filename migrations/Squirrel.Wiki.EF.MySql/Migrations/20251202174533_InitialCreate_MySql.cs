        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CreatedOn = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true),
                    Markup = table.Column<string>(type: "longtext", nullable: true),
                    FooterLeftZone = table.Column<string>(type: "longtext", nullable: true),
                    FooterRightZone = table.Column<string>(type: "longtext", nullable: true),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PluginType = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    IsEnabled = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsConfigured = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    LoadOrder = table.Column<int>(type: "int", nullable: false),
                    IsCorePlugin = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedOn = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ModifiedBy = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false),
                    IsFromEnvironment = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    EnvironmentVariableName = table.Column<string>(type: "longtext", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    LastLoginOn = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastPasswordChangeOn = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFromEnvironment = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    EnvironmentVariableName = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    PluginId = table.Column<Guid>(type: "char(36)", nullable: false),
                    PluginIdentifier = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedOn = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EditedBy = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false),
                    EditedOn = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    VersionNumber = table.Column<int>(type: "int", nullable: false),
                    ChangeComment = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
